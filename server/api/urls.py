...
from .views import user_list_create, user_detail, place_list_create, place_detail, place_ratings
...
urlpatterns = [
    ...
    path('places/<int:pk>/ratings', place_ratings, name='place-ratings'),
